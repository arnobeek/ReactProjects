  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <p className='text-gray-500 font-medium mt-4'>Appointment fee: <span className='text-gray-600'> UGX {docInfo.fees}</span></p>
        </div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button className='bg-[#5f6FFF] text-white text-sm font-light px-14 py-3 rounded-full mt-4 hover:cursor-pointer'>Book an Appointment</button>
