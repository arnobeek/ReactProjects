    ...
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-2 text-gray-600'>
            <li>+256-780-937-516</li>
            <li>musawohub@gmail.com</li>
          </ul>

        </div>
      </div>
      <div>
        <hr className='border-[#5f6FFF]' />
        <p className='py-5 text-sm text-center'>Copyright © 2025 MusawoHub - All Rights Reserved</p>
      </div>
    </div>
  )
}
