...
export default function Navbar(){
    ...
    return(
        <div className="flex items-center justify-between text-md py-3 mb-5 border-b border-b-gray-400">
            ...
            <div className="flex items-center gap-4">
                    ...
                    token ? <div className="flex items-center gap-2 cursor-pointer group relative">
                        ...
                        <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
                            <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4">
                                ...
                                <p onClick={() => setToken(false)} className="hover:text-black">Log out</p>
                            </div>
                        </div>
                ...
                <div className={`${showMenu ? 'fixed w-full h-full' : 'h-0 w-0'} md:hidden right-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                    ...
                    <ul className="flex flex-col items-center gap-2 mt-5 ext-lg font-medium">
